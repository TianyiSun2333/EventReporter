package com.laioffer.eventreporter.eventreportactivity;
...
import com.laioffer.eventreporter.util.LocationTracker;
...
// create new event and save to Firebase
public class EventReportActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mImageViewCamera.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                // start a implicit intent
                Intent intent = new Intent(
                        Intent.ACTION_PICK,
                        android.provider.MediaStore.Images.Media.EXTERNAL_CONTENT_URI);
                // start a new activity and get back the result
                // actually call onActivityResult() method to get data from another activity
                // <RESULT_LOAD_IMAGE>: the int to identify the target activity manually
    ...
    /**
     * A call back function that Sends intent to launch gallery for us to pick up images,
     * once the action finishes, images will be returns as parameters in this function
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        try {
            // if the request is image && result is correct && data exist
    ...
    private String uploadEvent() {
        ...
        // push data to DB, DB generate a ID
        // child(): get the sub json under the current JSON
        // can be table or document
    ...
    private void uploadImage(final String eventId) {
        ...
        // use time stamp to uniquely identify a picture and avoid rewriting image when two images
        // are the same
