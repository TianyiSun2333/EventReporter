package com.laioffer.eventreporter.commentactivity;
...
import com.laioffer.eventreporter.artifact.Comment;
...
public class CommentAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    // since we need to put event and comment all in one Recycler view
    // so we need to distinguish the two part
    ...
    public int getItemViewType(int position) {
        // the 0th position is the event type
    ...
    private void configureEventView(final EventViewHolder holder) {
        ...
        holder.eventImgViewGood.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                databaseReference.child("events").addListenerForSingleValueEvent(
