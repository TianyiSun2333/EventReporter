        ...
        mDatabaseReference.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                if (mRecyclerView.getAdapter() != null) {
                    // update the page when data gets updated
                    // the same with calling onCreate and onBind
        ...
        mDatabaseReference.child("comments").child(key)
            ...
            public void onComplete(DatabaseError databaseError,
                ...
                if (databaseError != null) {
                    // makeText(context, msg, duration of toast)
                    Toast toast = Toast.makeText(
                            getApplicationContext(),
                            "The comment is failed, please check you network status.",
                            Toast.LENGTH_SHORT
                    );
                    toast.show();
                } else {
