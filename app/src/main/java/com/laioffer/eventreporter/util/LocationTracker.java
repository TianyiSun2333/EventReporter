package com.laioffer.eventreporter.util;
...
public class LocationTracker implements LocationListener {
    ...
    // updating distance range
    private static final long MIN_DISTANCE_CHANGE_FOR_UPDATES = 10;

    // updating frequency
    private static final long MIN_TIME_BW_UPDATES = 1000 * 60;

    // two ways to get location: GPS or Network
    ...
    // runtime permission check, not only installation check at manifest
    ...
    // transfer lat and lng to address
    public static JSONObject getLocationInfo(double lat, double lng) {
        HttpGet httpGet = new HttpGet("http://maps.googleapis.com/maps/api/geocode/json?latlng="
                + lat+","+lng +"&sensor=true");
