...
import com.laioffer.eventreporter.artifact.User;
import com.laioffer.eventreporter.eventsactivity.EventActivity;
...
public class LoginActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // get the Document in the database with a key of "message"
        DatabaseReference myRef = database.getReference("message");
        // set the value of that Document with the key of "message"
